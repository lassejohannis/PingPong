  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-[#666] mt-1">Customize what prospects see when they open your pitch link.</p>
      </div>
          ...
          <div className="bg-[#111] border border-[#1e1e1e] rounded-xl p-5 space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              <textarea
                ...
                placeholder={`Leave empty for auto-generated: "Hey! I know [prospect] is doing great work. I can walk you through how ${companyName} can help..."`}
                rows={3}
